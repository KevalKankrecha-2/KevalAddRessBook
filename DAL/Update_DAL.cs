...
{
    public class Update_DAL
    {
        #region Update_Country 
        public string Update_Country(string conn, int UserID, string StoreProcedure, string CountryName, string CountryCode,int? CountryID)
        {
            try
            {
        ...
        #region Update_State
        public string Update_State(string conn, int UserID, string StoreProcedure, string StateName, string StateCode, int CountryID,int? StateID)
        {
            try
            {
                SqlDatabase sqlDB = new SqlDatabase(conn);
        ...
        #region Update_City
        public string Update_City(string conn, int UserID, string StoreProcedure, string CityName, string CityCode, int CountryID, int StateID,int? CityID)
        {
            try
            {
                SqlDatabase sqlDB = new SqlDatabase(conn);
        ...
        #region Update_ContactCategory
        public string Update_ContactCategory(string conn, int UserID, string StoreProcedure, string ContactCategoryName,int? ContactCategoryID)
        {
            try
            {
                SqlDatabase sqlDB = new SqlDatabase(conn);
        ...
        public string Update_Contact(string conn, int UserID, string StoreProcedure, string ContactName, int CountryID, int StateID, int CityID, int ContactCategoryID, string ContactNo, string WhatsappNo, DateTime BirthDate, string Email, int Age, string Address, string BloodGroup, string FaceBookID, string InstaID, string PhotoPath,int? ContactID)
        {
            try
            {
                SqlDatabase sqlDB = new SqlDatabase(conn);
